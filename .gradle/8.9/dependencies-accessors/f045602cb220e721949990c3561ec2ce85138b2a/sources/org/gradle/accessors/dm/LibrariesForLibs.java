...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    /**
     * Group of libraries at <b>encrypted</b>
     */
    ...
    public static class EncryptedLibraryAccessors extends SubDependencyFactory {
        private final EncryptedSharedLibraryAccessors laccForEncryptedSharedLibraryAccessors = new EncryptedSharedLibraryAccessors(owner);

        public EncryptedLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>encrypted.shared</b>
         */
        public EncryptedSharedLibraryAccessors getShared() {
            return laccForEncryptedSharedLibraryAccessors;
        }

    }

    public static class EncryptedSharedLibraryAccessors extends SubDependencyFactory {

        public EncryptedSharedLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>prefs</b> with <b>androidx.security:security-crypto-ktx</b> coordinates and
         * with version reference <b>encrypted.shared.prefs</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getPrefs() {
            return create("encrypted.shared.prefs");
        }
    ...
    public static class HiltLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>kapt</b> with <b>com.google.dagger:hilt-compiler</b> coordinates and
         * with version reference <b>dagger.hilt</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class OkLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>http</b> with <b>com.squareup.okhttp3:logging-interceptor</b> coordinates and
         * with version reference <b>ok.http.version</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final EncryptedVersionAccessors vaccForEncryptedVersionAccessors = new EncryptedVersionAccessors(providers, config);
        ...
        private final OkVersionAccessors vaccForOkVersionAccessors = new OkVersionAccessors(providers, config);
        ...
        /**
         * Version alias <b>ksp</b> with value <b>2.1.10-RC-1.0.29</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>mapsCompose</b> with value <b>2.14.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Group of versions at <b>versions.encrypted</b>
         */
        public EncryptedVersionAccessors getEncrypted() {
            return vaccForEncryptedVersionAccessors;
        }
        ...
        /**
         * Group of versions at <b>versions.ok</b>
         */
        public OkVersionAccessors getOk() {
            return vaccForOkVersionAccessors;
        }
    ...
    public static class DaggerVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>dagger.hilt</b> with value <b>2.53.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class EncryptedVersionAccessors extends VersionFactory  {

        private final EncryptedSharedVersionAccessors vaccForEncryptedSharedVersionAccessors = new EncryptedSharedVersionAccessors(providers, config);
        public EncryptedVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Group of versions at <b>versions.encrypted.shared</b>
         */
        public EncryptedSharedVersionAccessors getShared() {
            return vaccForEncryptedSharedVersionAccessors;
        }

    }

    public static class EncryptedSharedVersionAccessors extends VersionFactory  {

        public EncryptedSharedVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>encrypted.shared.prefs</b> with value <b>1.1.0-alpha06</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getPrefs() { return getVersion("encrypted.shared.prefs"); }
    ...
    public static class OkVersionAccessors extends VersionFactory  {

        private final OkHttpVersionAccessors vaccForOkHttpVersionAccessors = new OkHttpVersionAccessors(providers, config);
        public OkVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Group of versions at <b>versions.ok.http</b>
         */
        public OkHttpVersionAccessors getHttp() {
    ...
    public static class OkHttpVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>ok.http.version</b> with value <b>5.0.0-alpha.6</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getVersion() { return getVersion("ok.http.version"); }
    ...
    public static class PluginPluginAccessors extends PluginFactory {
        ...
        /**
         * Plugin provider for <b>plugin.serialization</b> with plugin id <b>plugin.serialization</b> and
         * with version reference <b>kotlin</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
